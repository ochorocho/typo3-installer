...
export class PackageList extends LitElement {
  ...
  render() {
    ...
    if (this.error) return html`<t3-section-error title="Failed to Load Packages" .message=${this.error.message} .details=${this.error.details || ''} context="general"></t3-section-error>`;
