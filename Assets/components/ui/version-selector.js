...
export class VersionSelector extends LitElement {
  ...
  render() {
    ...
    if (this.error) return html`<t3-section-error title="Failed to Load Versions" .message=${this.error.message} .details=${this.error.details || ''} context="general"></t3-section-error>`;
